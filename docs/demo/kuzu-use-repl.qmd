...
subtitle: ""
description: |
  * [Source file](https://github.com/DylanShang/kuzu-lab/blob/main/examples/Quarto/repl-example.qmd)

categories: [kuzu, pyvis, quarto]
author: "[Dylan Shang](https://github.com/DylanShang)"
date: 2024-08-25
format:
  html:
    page-layout: full
...
iframe = f'<iframe src="{jupyterlite}" style="width:1000px;height:600px;"></iframe>'
print(iframe)
```
